...
CREATE TEMP TABLE temp.l53ocs1vdigits
AS
SELECT
digits.n  
FROM
...
CREATE TEMP TABLE temp.l53ocs1vgenerate_dates
AS
SELECT
y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
	mths.n as d_months
FROM
temp.l53ocs1vdigits y1,
temp.l53ocs1vdigits y10,
...
CREATE TEMP TABLE temp.l53ocs1vyearly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
temp.l53ocs1vgenerate_dates
where d_months = 1
;

CREATE TEMP TABLE temp.l53ocs1vmonthly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
...
CREATE TEMP TABLE temp.l53ocs1vweekly_dates
AS
SELECT
...
(
	...
	from temp.l53ocs1vdigits d1, temp.l53ocs1vdigits d10, temp.l53ocs1vdigits d100, temp.l53ocs1vdigits d1000
) seq;

CREATE TEMP TABLE temp.l53ocs1vquarterly_dates
AS
SELECT
...
-- monthly dates
CREATE TEMP TABLE temp.l53ocs1vtemp_period
AS
SELECT
*
FROM
...
from temp.l53ocs1vmonthly_dates md
UNION ALL
...
from temp.l53ocs1vweekly_dates wd
...
from temp.l53ocs1vquarterly_dates qd
UNION ALL
...
from temp.l53ocs1vyearly_dates yd
...
from temp.l53ocs1vtemp_period;

truncate table temp.l53ocs1vdigits;

drop table temp.l53ocs1vdigits;

truncate table temp.l53ocs1vgenerate_dates;

drop table temp.l53ocs1vgenerate_dates;

truncate table temp.l53ocs1vyearly_dates;

drop table temp.l53ocs1vyearly_dates;

truncate table temp.l53ocs1vquarterly_dates;

drop table temp.l53ocs1vquarterly_dates;

truncate table temp.l53ocs1vmonthly_dates;

drop table temp.l53ocs1vmonthly_dates;

truncate table temp.l53ocs1vweekly_dates;

drop table temp.l53ocs1vweekly_dates;

TRUNCATE TABLE temp.l53ocs1vtemp_period;

DROP TABLE temp.l53ocs1vtemp_period;
