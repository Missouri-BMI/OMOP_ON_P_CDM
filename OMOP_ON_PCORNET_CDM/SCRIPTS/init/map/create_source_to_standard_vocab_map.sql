create or replace table {{ cdm_db }}.{{ vocabulary }}.source_to_standard_vocab_map
as
with cte_vocab_map as (
       ...
       from {{ cdm_db }}.{{ vocabulary }}.concept as c
       join {{ cdm_db }}.{{ vocabulary }}.concept_relationship cr
              on c.concept_id = cr.concept_id_1
              and cr.invalid_reason is null
              and lower(cr.relationship_id) = cast('maps to' as string) 
       join {{ cdm_db }}.{{ vocabulary }}.concept c1
       ...
       from {{ cdm_db }}.{{ vocabulary }}.source_to_concept_map stcm
       left outer join {{ cdm_db }}.{{ vocabulary }}.concept c1
              on c1.concept_id = stcm.source_concept_id
       left outer join {{ cdm_db }}.{{ vocabulary }}.concept c2
