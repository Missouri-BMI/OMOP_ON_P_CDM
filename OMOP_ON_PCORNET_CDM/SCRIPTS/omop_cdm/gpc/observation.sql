...
SELECT DISTINCT
   ...
   ROW_NUMBER() OVER (ORDER BY enc.encounter_num) ::INTEGER AS observation_id,
    0 AS observation_source_concept_id,
    'DRG|'||enc.DRG AS observation_source_value,
    38000280 AS observation_type_concept_id,
    enc.patient_num AS person_id,
    ...
    enc.encounter_num AS visit_occurrence_id
FROM
    {pcornet_db}.{pcornet_schema}.GPC_DEID_encounter enc
LEFT JOIN
