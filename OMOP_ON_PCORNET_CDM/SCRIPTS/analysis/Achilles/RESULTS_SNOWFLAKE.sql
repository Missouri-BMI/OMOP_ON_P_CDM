...
CREATE TEMP TABLE temp.ra5n2nfadigits
AS
SELECT
digits.n  
FROM
...
CREATE TEMP TABLE temp.ra5n2nfagenerate_dates
AS
SELECT
y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
	mths.n as d_months
FROM
temp.ra5n2nfadigits y1,
temp.ra5n2nfadigits y10,
...
CREATE TEMP TABLE temp.ra5n2nfayearly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
temp.ra5n2nfagenerate_dates
where d_months = 1
;

CREATE TEMP TABLE temp.ra5n2nfamonthly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
...
CREATE TEMP TABLE temp.ra5n2nfaweekly_dates
AS
SELECT
...
(
	...
	from temp.ra5n2nfadigits d1, temp.ra5n2nfadigits d10, temp.ra5n2nfadigits d100, temp.ra5n2nfadigits d1000
) seq;

CREATE TEMP TABLE temp.ra5n2nfaquarterly_dates
AS
SELECT
...
-- monthly dates
CREATE TEMP TABLE temp.ra5n2nfatemp_period
AS
SELECT
*
FROM
...
from temp.ra5n2nfamonthly_dates md
UNION ALL
...
from temp.ra5n2nfaweekly_dates wd
...
from temp.ra5n2nfaquarterly_dates qd
UNION ALL
...
from temp.ra5n2nfayearly_dates yd
...
from temp.ra5n2nfatemp_period;

truncate table temp.ra5n2nfadigits;

drop table temp.ra5n2nfadigits;

truncate table temp.ra5n2nfagenerate_dates;

drop table temp.ra5n2nfagenerate_dates;

truncate table temp.ra5n2nfayearly_dates;

drop table temp.ra5n2nfayearly_dates;

truncate table temp.ra5n2nfaquarterly_dates;

drop table temp.ra5n2nfaquarterly_dates;

truncate table temp.ra5n2nfamonthly_dates;

drop table temp.ra5n2nfamonthly_dates;

truncate table temp.ra5n2nfaweekly_dates;

drop table temp.ra5n2nfaweekly_dates;

TRUNCATE TABLE temp.ra5n2nfatemp_period;

DROP TABLE temp.ra5n2nfatemp_period;
