...
CREATE TEMP TABLE temp.wbe3cmh7digits
AS
SELECT
digits.n  
FROM
...
CREATE TEMP TABLE temp.wbe3cmh7generate_dates
AS
SELECT
y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
	mths.n as d_months
FROM
temp.wbe3cmh7digits y1,
temp.wbe3cmh7digits y10,
...
CREATE TEMP TABLE temp.wbe3cmh7yearly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
temp.wbe3cmh7generate_dates
where d_months = 1
;

CREATE TEMP TABLE temp.wbe3cmh7monthly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
...
CREATE TEMP TABLE temp.wbe3cmh7weekly_dates
AS
SELECT
...
(
	...
	from temp.wbe3cmh7digits d1, temp.wbe3cmh7digits d10, temp.wbe3cmh7digits d100, temp.wbe3cmh7digits d1000
) seq;

CREATE TEMP TABLE temp.wbe3cmh7quarterly_dates
AS
SELECT
...
-- monthly dates
CREATE TEMP TABLE temp.wbe3cmh7temp_period
AS
SELECT
*
FROM
...
from temp.wbe3cmh7monthly_dates md
UNION ALL
...
from temp.wbe3cmh7weekly_dates wd
...
from temp.wbe3cmh7quarterly_dates qd
UNION ALL
...
from temp.wbe3cmh7yearly_dates yd
...
truncate table temp.wbe3cmh7digits;

drop table temp.wbe3cmh7digits;

truncate table temp.wbe3cmh7generate_dates;

drop table temp.wbe3cmh7generate_dates;

truncate table temp.wbe3cmh7yearly_dates;

drop table temp.wbe3cmh7yearly_dates;

truncate table temp.wbe3cmh7quarterly_dates;

drop table temp.wbe3cmh7quarterly_dates;

truncate table temp.wbe3cmh7monthly_dates;

drop table temp.wbe3cmh7monthly_dates;

truncate table temp.wbe3cmh7weekly_dates;

drop table temp.wbe3cmh7weekly_dates;

TRUNCATE TABLE temp.wbe3cmh7temp_period;

DROP TABLE temp.wbe3cmh7temp_period;
