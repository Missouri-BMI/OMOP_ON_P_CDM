...
USE TRACS_CDM;
truncate table tracs_cdm.omop.drug_era;
...
INSERT INTO OMOP.drug_era(drug_era_id,person_id, drug_concept_id, drug_era_start_date, drug_era_end_date, drug_exposure_count, gap_days)
SELECT * FROM #tmp_de;
