...
CREATE TEMP TABLE temp.aota0zgpdigits
AS
SELECT
digits.n  
FROM
...
CREATE TEMP TABLE temp.aota0zgpgenerate_dates
AS
SELECT
y1.n + (10*y10.n) + (100*y100.n) + (1000*y1000.n) AS d_years,
	mths.n as d_months
FROM
temp.aota0zgpdigits y1,
temp.aota0zgpdigits y10,
...
CREATE TEMP TABLE temp.aota0zgpyearly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
temp.aota0zgpgenerate_dates
where d_months = 1
;

CREATE TEMP TABLE temp.aota0zgpmonthly_dates
AS
SELECT
TO_DATE(TO_CHAR(d_years,'FM0000')||'-'||TO_CHAR(d_months,'FM00')||'-'||TO_CHAR(01,'FM00'), 'YYYY-MM-DD') as generated_date
FROM
...
CREATE TEMP TABLE temp.aota0zgpweekly_dates
AS
SELECT
...
(
	...
	from temp.aota0zgpdigits d1, temp.aota0zgpdigits d10, temp.aota0zgpdigits d100, temp.aota0zgpdigits d1000
) seq;

CREATE TEMP TABLE temp.aota0zgpquarterly_dates
AS
SELECT
...
-- monthly dates
CREATE TEMP TABLE temp.aota0zgptemp_period
AS
SELECT
*
FROM
...
from temp.aota0zgpmonthly_dates md
UNION ALL
...
from temp.aota0zgpweekly_dates wd
...
from temp.aota0zgpquarterly_dates qd
UNION ALL
...
from temp.aota0zgpyearly_dates yd
...
from temp.aota0zgptemp_period;

truncate table temp.aota0zgpdigits;

drop table temp.aota0zgpdigits;

truncate table temp.aota0zgpgenerate_dates;

drop table temp.aota0zgpgenerate_dates;

truncate table temp.aota0zgpyearly_dates;

drop table temp.aota0zgpyearly_dates;

truncate table temp.aota0zgpquarterly_dates;

drop table temp.aota0zgpquarterly_dates;

truncate table temp.aota0zgpmonthly_dates;

drop table temp.aota0zgpmonthly_dates;

truncate table temp.aota0zgpweekly_dates;

drop table temp.aota0zgpweekly_dates;

TRUNCATE TABLE temp.aota0zgptemp_period;

DROP TABLE temp.aota0zgptemp_period;
