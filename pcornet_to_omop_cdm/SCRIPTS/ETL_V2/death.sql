...
FROM DEIDENTIFIED_PCORNET_CDM.CDM.deid_death d
left join DEIDENTIFIED_PCORNET_CDM.CDM.deid_death_cause dc on dc.patid=d.patid
...
left join CROSSWALK.omop_pcornet_valueset_mapping dt
